...
EXPECTED_DIR = GOLDEN_DIR / "expected" / "bpy"
...
def run_boolean_workflow() -> Dict[str, Dict[str, Any]]:
    ...
    death_receptor_model = bt.bpy.io.read_zginml(DEATH_RECEPTOR_CELL_FATE_PATH)
    synthetic_model = bt.bpy.io.read_zginml(SYNTHETIC_30_NODE_DYNAMICS_PATH)
...
def _canonical_attractors(
    attractors: Tuple[bt.bpy.ba.ConfigurationSet, ...],
