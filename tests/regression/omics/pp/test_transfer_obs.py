...
def test_transfer_obs_to_integrated_handles_colliding_cell_ids():
    ...
    result = bt.omics.pp.transfer_obs_to_integrated(
        integrated,
        adatas,
...
def test_transfer_obs_to_integrated_copy_does_not_mutate_input():
    ...
    copied = bt.omics.pp.transfer_obs_to_integrated(
        integrated,
        adatas,
        obs="local_score",
        conditions=["ctrl", "stim"],
...
def test_transfer_obs_to_integrated_keeps_unmatched_integrated_cells_as_missing():
    ...
    bt.omics.pp.transfer_obs_to_integrated(
        integrated,
        [ctrl, stim],
        obs="local_score",
        conditions=["ctrl", "stim"],
...
def test_transfer_obs_to_specific_matches_conditions():
    ...
    result = bt.omics.pp.transfer_obs_to_specific(
        integrated,
        adatas,
...
def test_transfer_obs_to_specific_copy_does_not_mutate_inputs():
    ...
    copied_adatas = bt.omics.pp.transfer_obs_to_specific(
        integrated,
        adatas,
        obs="global_score",
        conditions=["ctrl", "stim"],
...
def test_transfer_obs_to_specific_keeps_unmatched_specific_cells_as_missing():
    ...
    bt.omics.pp.transfer_obs_to_specific(
        integrated,
        adatas,
        obs="global_score",
        conditions=["ctrl", "stim"],
