...
from bonesistools.omics.input_output import _nestorowa as nestorowa_module
...
def test_io_load_nestorowa_uses_cache(monkeypatch, tmp_path):
    ...
    first = bt.omics.io.load("nestorowa", quiet=True)
    second = bt.omics.io.load("nestorowa", quiet=True)
