...
def transfer_obs_sti(*args: Any, **kwargs: Any) -> Union[AnnData, None]:
    ...
    _warn_deprecated(
        "`bt.omics.pp.transfer_obs_sti`",
        replacement="`bt.omics.pp.transfer_obs_to_integrated`",
        stacklevel=2,
    )
...
def transfer_obs_its(*args: Any, **kwargs: Any) -> Union[AnnDataList, None]:
    ...
    _warn_deprecated(
        "`bt.omics.pp.transfer_obs_its`",
        replacement="`bt.omics.pp.transfer_obs_to_specific`",
        stacklevel=2,
    )
