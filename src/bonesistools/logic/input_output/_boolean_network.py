...
if TYPE_CHECKING:
    from ..boolean_network._network import BooleanNetwork, BooleanNetworkEnsemble
...
def read_bnet(
    ...
    from ..boolean_network._network import BooleanNetwork
...
def read_bnet_directory(
    ...
    from ..boolean_network._network import BooleanNetworkEnsemble
