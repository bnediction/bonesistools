...
def similarity(
    ...
    Examples
    --------
    >>> bt.logic.ig.similarity(ig1, ig2)

    >>> dorothea = bt.resources.omnipath.dorothea()
    >>> bt.logic.ig.similarity(ig1, ig2, metric="hamming", domain=dorothea)
...
def distance(
    ...
    Examples
    --------
    >>> bt.logic.ig.distance(ig1, ig2)

    >>> dorothea = bt.resources.omnipath.dorothea()
    >>> bt.logic.ig.distance(ig1, ig2, metric="hamming", domain=dorothea)
